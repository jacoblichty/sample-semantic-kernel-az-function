...
class QueryDbPlugin:
    ...
    def query_db(self, context: KernelContext) -> str:    
        ...
        conn = pyodbc.connect('DRIVER={ODBC Driver 18 for SQL Server};SERVER=hackathontempserver.database.windows.net,1433', user='azSA', password='admin@23', database='hackathon')
